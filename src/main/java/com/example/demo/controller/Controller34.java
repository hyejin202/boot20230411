...
public class Controller34 {
	...
	public void method3(String name) {
		System.out.println("link3메소드 일함");
	...
	// /sub34/link7?address=cheongju&name=park&age=52
	@GetMapping("link7")
	...
	// /sub34/link8?price=3.14&product=lotion&category=beauty
	@GetMapping("link8")
