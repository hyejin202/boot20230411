...
public class Controller35 {
	...
	@PostMapping("link1")
	public void method1() {
		System.out.println("post 요청 잘 받음");
	}
	...
	public void method4(String address, Double price) {
		System.out.println("address : " + address + ", price : " + price);
	}
	...
	public void method7(@RequestBody Map map) {
		System.out.println("메소드 7 실행됨");
		System.out.println(map);  //{name=son}
	...
	public void method11(@RequestBody Map<String, Object> map) {
		...
		System.out.println(book.get("titile"));
