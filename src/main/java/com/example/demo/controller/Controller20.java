...
public class Controller20 {
	...
	public void method5(@RequestParam("id") Integer employeeId) {  //@RequestParam("id") 생략가능
		System.out.println(mapper.method5(employeeId));
	}
	...
	public void method8() {
		Dto05 dto = mapper.method11();
		System.out.println(dto);
	}
	
	@RequestMapping("link9")
	public void method9() {
		Customer c = mapper.method12();
	...
	//method11 mapper.method14() 실행결과 콘솔에 출력
