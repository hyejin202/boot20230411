...
<body>
	...
	<div>
		<button id="btn5">성공 응답, done, fail, always</button>
	</div>
	<div>
		<button id="btn6">실패 응답, done, fail, always</button>
	</div>
	<div>
		<button id="btn7">성공응답(200)</button>
	</div>
	<div>
		<button id="btn8">실패응답(500)</button>
	</div>
	...
	<div>
		<button id="btn10">본문있는 성공 응답</button>
		<div id="res10"></div>
	</div>
	<div>
	...
	<div>
		<input type="text" id="categoryInput" value="1" />
